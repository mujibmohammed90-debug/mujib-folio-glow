...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Mujib Mohammed | Frontend Developer Portfolio" },
      {
        name: "description",
        content:
          "Portfolio of Mujib Mohammed, Frontend Developer and 3rd year Information Technology student at Werabe University.",
      },
      { name: "author", content: "Mujib Mohammed" },
